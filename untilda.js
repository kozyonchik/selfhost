...
//---------------------------------------------------------------------------
    ...
    function fix_position_of_elements(){
        ...
        $.each( achiver2, function( key, value ) {
            ...
            //console.log(value[0]);
            (!$this.hasClass('helpblock')?$this.addClass('hypeblock'):'');
            $this.prepend('<div class="customcontrol special"><div class="cc_but note tooltiper"><div class="th_out"><div class="th_in"><i class="fas fa-sticky-note"></i></div></div><div class="cc_noter"><b>Название блока</b><br><br> '+value[1]+'<br></div></div><div class="cc_but preview"><div class="th_out"><div class="th_in"><i class="fas fa-eye"></i></div></div></div></div>')
            /**/
        });
